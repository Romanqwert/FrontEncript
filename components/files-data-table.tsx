        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent border-border">
              ...
              {showDownloadButton && <TableHead className="text-right">Acciones</TableHead>}
            </TableRow>
          </TableHeader>
          <TableBody>
            {currentFiles.map((file) => (
              <TableRow key={file.idArchivo} className="border-border">
                ...
                <TableCell className="font-medium">
                  <div className="max-w-xs truncate">{file.nombreArchivo}</div>
                </TableCell>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between px-2">
          <div className="text-sm text-muted-foreground">
            Mostrando {startIndex + 1} a {Math.min(endIndex, files.length)} de {files.length} archivos
          </div>
