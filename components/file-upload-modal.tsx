                ...
                <div className="p-4 space-y-1">
                  {keys.map((key) => {
                    ...
                    return (
                      ...
                      >
                        {isParent && <ChevronRight className="h-3 w-3 text-muted-foreground flex-shrink-0" />}
                        ...
                        />
                        <Label htmlFor={key} className="font-normal cursor-pointer flex-1 text-sm" title={key}>
                          <span className={isParent ? "font-medium" : ""}>{keyName}</span>
                          {isSelected && isParent && (
